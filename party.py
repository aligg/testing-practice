...
def is_mel(name, email):
    ...
    >>> is_mel('Chuck Barry', 'mel@ubermelon.com')
    True
    ...
    return name.lower() == "mel melitpolski" or email.lower() == "mel@ubermelon.com" or 'mel' in name.lower().split()
...
def most_and_least_common_type(treats):
    ...
    >>> treats = [{'type': 'ice cream'}, {'type': 'ice cream'}, {'type': 'appetizer'}, {'type': 'ice cream'}, {'type': 'appetizer'}, {'type': 'drink'},]

    >>> most_and_least_common_type(treats)
    ('ice cream', 'drink')

    >>> treats = [{'type': 'ice cream'}, {'type': 'ice cream'}, {'type': 'appetizer'}, {'type': 'ice cream'}, {'type': 'appetizer'}, {'type': 'appetizer'}, {'type': 'drink'}]

    >>> most_and_least_common_type(treats)
    ('ice cream', 'drink')

    >>> treats = [{'type': 'ice cream'}, {'type': 'ice cream'}]
